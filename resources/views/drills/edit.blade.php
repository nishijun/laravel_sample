                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('drills.update', $drill->id) }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="problem{{ $i }}" type="text" class="form-control @error('problem'.$i) is-invalid @enderror" name="problem{{$i}}" value="{{ $drill['problem'.$i] }}" autocomplete="problem{{$i}}" autofocus>
